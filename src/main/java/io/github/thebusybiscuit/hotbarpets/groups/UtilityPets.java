...
public final class UtilityPets implements PetGroup {
    ...
    public String getName() {
        return "&aПолезные (Мирные)";
    }

    @Override
    public void load(HotbarPets plugin) {
        // @formatter:off
        new BedPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_BED", Material.RED_BED, "&fПитомец Кровать", getName(), "&7Любимая Еда: Шерсть", "", "&fПКМ: &7Поспать"), new ItemStack(Material.WHITE_WOOL), new ItemStack[] {
        ...
        new EnderChestPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_ENDER_CHEST", PetTexture.ENDER_CHEST_PET.getHash(), "&5Питомец Сундук Края", getName(), "&7Любимая Еда: Эндерперл", "", "&fПКМ: &7Открыть"), new ItemStack(Material.ENDER_PEARL), new ItemStack[] {
        ...
        new WorkbenchPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_WORKBENCH", PetTexture.WORKBENCH_PET.getHash(), "&6Питомец Верстак", getName(), "&7Любимая Еда: Доски", "", "&fПКМ: &7Открыть"), new ItemStack(Material.OAK_PLANKS), new ItemStack[] {
