...
public final class HostileMobs implements PetGroup {
    ...
    public String getName() {
        return "&cМоб (Враждебный)";
    }

    @Override
    public void load(HotbarPets plugin) {
        // @formatter:off
        new SpiderPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_SPIDER", PetTexture.SPIDER_PET.getHash(), "&8Питомец Паук", getName(), "&7Любимая еда: Гнилая Плоть", "", "&fПКМ: &7Дает вам буст к прыжку"), new ItemStack(Material.ROTTEN_FLESH), new ItemStack[]{
        ...
        new GhastPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_GHAST", PetTexture.GHAST_PET.getHash(), "&fПитомец Гаст", getName(), "&7Любимая еда: Огненный Заряд", "", "&fПКМ: &7Выпускает фаерболлы"), new ItemStack(Material.FIRE_CHARGE), new ItemStack[]{
        ...
        new ShulkerPet(plugin, new SlimefunItemStack("HOTBAR_PET_SHULKER", PetTexture.SHULKER_PET.getHash(), "&dПитомец Шалкер", getName(), "&7Любимая еда: Фрукт Хоруса", "", "&fПКМ: &7Стреляет стрелами с левитационным наконечником"), new ItemStack(Material.CHORUS_FRUIT), new ItemStack[]{
        ...
        new PhantomPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_PHANTOM", PetTexture.PHANTOM_PET.getHash(), "&7Питомец Фантом", getName(), "&7Любимая еда: Свекла", "", "&fПКМ: &7Дает эффект медленного падения"), new ItemStack(Material.BEETROOT), new ItemStack[]{
        ...
        new EndermanPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_ENDER_MAN", PetTexture.ENDERMAN_PET.getHash(), "&8Питомец Эндермэн", getName(), "&7Любимая еда: Камень Энда", "", "&fПКМ: &7Стреляет Эндер перлами"), new ItemStack(Material.END_STONE), new ItemStack[]{
        ...
        new CreeperPet(plugin, new SlimefunItemStack("HOTBAR_PET_CREEPER", Material.CREEPER_HEAD, "&2Питомец Крипер", getName(), "&7Любимая еда: Порох", "", "&fИммунитет к взрывам", "&fПКМ: &7Взрыв"), new ItemStack(Material.GUNPOWDER), new ItemStack[]{
        ...
        new HotbarPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_MAGMA_CUBE", PetTexture.MAGMA_CUBE_PET.getHash(), "&4Питомец Магма Куб", getName(), "&7Любимая еда: Кварц Незера", "", "&fИммунитет к лаве", "&fОчень голоден"), new ItemStack(Material.QUARTZ), new ItemStack[]{
        ...
        new HotbarPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_BLAZE", PetTexture.BLAZE_PET.getHash(), "&6Питомец Блейз", getName(), "&7Любимая еда: Кварц Незера", "", "&fИммунитет к огню"), new ItemStack(Material.QUARTZ), new ItemStack[]{
        ...
        new HotbarPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_ZOMBIE", Material.ZOMBIE_HEAD, "&2Питомец Зомби", getName(), "", "&fПозволяет есть гнилую плоть", "&fНе бывает голоден"), new ItemStack(Material.ROTTEN_FLESH), new ItemStack[] {
